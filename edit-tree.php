...
<?php
 ...
 $sql = "SELECT Tree.*, Type.Type_Name FROM Tree
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="box all">
                            ...
                            <select name="txtType" class="form-control" style="width:300px;">
                                 <option value="<?= $result['Type']; ?>"><?php echo $result['Type_Name']; ?></option>
                                    <?php
                                        $sql2 = "SELECT * FROM Type ORDER BY Type_ID ASC";
                            ...
                            <?php 
                            if (!isset($result["Tree_Detail"])) {
                                echo "ไม่มีข้อมูล";
                            }
                            ?>
                            <textarea name="detail" id="detail" ><?php echo $result["Tree_Detail"]; ?></textarea>
                                <script>
